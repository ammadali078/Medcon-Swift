...
//    http://himont-dcr.digitrends.pk/webapi/GetMSRPlan/?employeeid=
    ...
    static let checkPass = "checkPass"
    static let notifyCount = "notifyCount"
    static let saveBrandData = "saveBrandData"
    static let forgotApi = "http://medconwebapi-v3.digitrends.pk/Account/ForgotPassword"
    static let oTPApi = "http://medconwebapi-v3.digitrends.pk/Account/verifyOtp"
    static let OTPtoken = "OTPtoken"
    static let createPasswordApi = "http://medconwebapi-v3.digitrends.pk/Account/resetpasswordwithcode"
    static let VideoApi = "http://medconwebapi-v3.digitrends.pk/api/VideoLibrary/Index"
    static let allBrandApi = "https://drugportal.a2hosted.com/api/brands/all"
    ...
    static let addFcm = "http://medconwebapi-v3.digitrends.pk/api/pushnotification/addfcm"
//    static let PAMArtApi = "http://medcon-webapi-beta.digitrends.pk/api/PatientAwareness/Index"
    static let PAMArtApi = "http://medconwebapi-v3.digitrends.pk/api/PatientAwareness/Index"
    static let getNotification = "http://medconwebapi-v3.digitrends.pk/api/PushNotification/GetAllPushNotification"
//    static let PopularApi = "http://medcon-webapi-beta.digitrends.pk/api/PatientAwareness/MostPopular"
    static let PopularApi = "http://medconwebapi-v3.digitrends.pk/api/PatientAwareness/MostPopular"
...
//    static let getPopArtDetail = "http://medcon-webapi-beta.digitrends.pk/api/PatientAwareness/PatientAwarnessArticleById"
    static let getPopArtDetail = "http://medconwebapi-v3.digitrends.pk/api/PatientAwareness/PatientAwarnessArticleById"
//    static let getArticleDetail = "http://medcon-webapi-beta.digitrends.pk/api/guideline/index"
    static let getArticleDetail = "http://medconwebapi-v3.digitrends.pk/api/guideline/index"
    ...
    static let DrugInterActionApi = "https://rxnav.nlm.nih.gov/REST/approximateTerm.json"
    static let getMedDetailApi = "https://rxnav.nlm.nih.gov/REST/interaction/list.json"
    static let LOGIN_RESULT = "login_result"
    static let ArtID = "ArtID"
    static let PopularID = "PopularID"
    static let checkID = "checkID"
    ...
    static let getImg = "getImg"
    static let getTitle = "getTitle"
    static let getHtml = "getHtml"
    static let getMedValue = "getMedValue"
    static let medID1 = "medID1"
    static let medID2 = "medID2"
    static let number = "number"
    static let selectSP = "selectSP"
    static let boxNumber = "boxNumber"
